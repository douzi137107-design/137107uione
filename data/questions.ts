...
export const questions: Question[] = [
  ...
  {
    q: "隐藏题：按钮位面对前位紧玩家加注，盲位还有一位爱跟注的玩家。你拿到一手边缘同花连张，第一反应更应该是？",
    options: [
      { text: "位置在我这里，边缘牌也能打出空间。", scores: [] },
      { text: "同花连张有潜力，进多人池反而更有想象力。", scores: [] },
      { text: "先看能否实现权益，不只看牌面漂亮不漂亮。", scores: [] },
      { text: "前位紧说明他好读，后面有人跟也不一定坏。", scores: [] },
    ],
  },
  {
    q: "隐藏题：你翻牌持续下注被跟注，转牌补出一张明显改变结构的牌。你拿着中等强度成牌，最合理的思路是？",
    options: [
      { text: "重新判断这张牌更帮谁，再决定要控池、下注还是放慢。", scores: [] },
      { text: "中等成牌不能太怂，继续下注才能保护自己的范围。", scores: [] },
      { text: "转牌变危险就少碰，先默认对手跟注范围变强了。", scores: [] },
      { text: "看对手反应，如果明显犹豫，可以继续施压。", scores: [] },
    ],
  },
  {
    q: "隐藏题：如果把德州扑克理解成一个长期游戏，哪句话最接近高手视角？",
    options: [
      { text: "强牌多拿价值，弱牌少犯错，这是核心。", scores: [] },
      { text: "读人比理论重要，看懂一个人就能做决定。", scores: [] },
      { text: "敢在关键节点施压，才能让对手难受。", scores: [] },
      { text: "在不完整信息里，持续做更难被利用的决策。", scores: [] },
    ],
  },
];
